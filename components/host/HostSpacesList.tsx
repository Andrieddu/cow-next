...
// IMPORTIAMO IL NOSTRO COMPONENTE DROPDOWN (che contiene già la modale di eliminazione!)
    ...
    <>
      ...
      <div className="grid grid-cols-1 gap-6">
        {filteredSpaces.length === 0 ? (
          <div className="bg-background rounded-[2rem] p-12 text-center shadow-sm border border-border/50 flex flex-col items-center justify-center">
          ...
          filteredSpaces.map((space) => {
            ...
            const totalBookings = space.bookings?.length || 0;
            ...
            return (
              ...
              >
                <div className="flex flex-col lg:flex-row gap-6">
                  ...
                  <div className="relative h-48 lg:h-40 w-full lg:w-64 rounded-2xl overflow-hidden shrink-0 border border-border/50 bg-muted">
                    ...
                    <div className="absolute top-3 left-3">
                      <Badge
                        className={
                          space.isActive
                            ? "bg-green-500 hover:bg-green-600 border-none text-white font-bold tracking-wide"
                            : "bg-yellow-500 hover:bg-yellow-600 border-none text-white font-bold tracking-wide"
                        }
                      >
                    ...
                    <div>
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <h3 className="text-xl font-bold text-foreground mb-1 pr-4">
                            {space.title}
                          </h3>
                        ...
                        {/* MENU A TENDINA REALE (Include visualizza, modifica, elimina) */}
                  ...
                  {/* Statistiche */}
                  <div className="flex flex-col justify-center shrink-0 lg:w-48 xl:w-56 lg:pl-6 lg:border-l border-border/50 mt-4 lg:mt-0">
                    {/* Su mobile 2 colonne, su desktop (lg) 1 colonna per metterli uno sotto l'altro */}
                    <div className="grid grid-cols-2 lg:grid-cols-1 gap-3">
                      <div className="bg-secondary/5 rounded-2xl p-3 md:p-4 border border-border/50 text-center flex flex-col justify-center">
