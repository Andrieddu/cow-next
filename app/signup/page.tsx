      ...
      <div className="w-full max-w-lg bg-background p-8 md:p-10 rounded-[2.5rem] shadow-xl border border-border/50">
        ...
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-sm font-medium text-muted-foreground px-4">
            Unisciti alla community CoW e prenota il tuo spazio in pochi
            secondi.
          </p>
        </div>
        ...
        <form action={signup}>
          <FieldSet>
            <FieldGroup>
              ...
              <Field>
                ...
                />
                <FieldDescription>
                  Ti invieremo qui le conferme di prenotazione.
                </FieldDescription>
              </Field>
          ...
          <FieldGroup>
            <p className="text-[11px] text-muted-foreground/80 font-medium leading-relaxed px-1">
        ...
        <Button
          variant="outline"
          className="w-full h-12 rounded-xl font-bold border-border/50 hover:bg-secondary/10 transition-colors mb-8"
        >
